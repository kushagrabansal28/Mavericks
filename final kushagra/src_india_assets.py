...
INDIA_RAW_NODES = [
    ...
    {"id": "T21", "type": "transformer", "label": "Pune Trans T21", "state": "Maharashtra", "region": "WR", "lat": 18.52, "lon": 73.86, "load": 60.0, "v": 0.98, "t": 53.0, "age": 10, "cap": 300.0},
...
INDIA_RAW_EDGES = [
    ...
    {"source": "F8", "target": "T21", "type": "feeder", "capacity": 200.0},
    {"source": "T21", "target": "S4", "type": "distribution", "capacity": 350.0},
